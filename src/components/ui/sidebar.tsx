  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 fixed inset-y-0 z-10 hidden h-svh transition-[width] ease-linear md:flex bg-sidebar",
             "w-[--sidebar-width]",
            side === "left"
              ? "left-0"
              : "right-0",
